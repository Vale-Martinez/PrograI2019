 ...
 * @author Dell
 */
public class TiquetesLotto extends Tiquetes{
    
    private int Num_elegido1, Num_elegido2, Num_elegido3, Num_elegido4, Num_elegido5, Num_elegido6, Num_elegido7;
    ...
    public TiquetesLotto(String emisor, String cliente, String tipo, int Num_elegido1, int Num_elegido2, int Num_elegido3, int Num_elegido4, int Num_elegido5, int Num_elegido6, int Num_elegido7){
