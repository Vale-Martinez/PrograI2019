...
public class Lotto extends Sorteos {
    ...
    public Lotto(String sorteo, String tipo, int codigo, int emisiones, Date Fecha_Sorteo, int Num_Ganador1, int Num_Ganador2, int Num_Ganador3, int Num_Ganador4, int Num_Ganador5, int Num_Ganador6, int Num_Ganador7, int Acumulado) {
